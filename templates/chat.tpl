			...
			<div class="modal-body">
				...
				<div class="input-group">
					...
					<span class="input-group-btn">
						<button id="chat-message-send-btn" class="btn btn-primary btn-raised" href="#" type="button">[[modules:chat.send]]</button>
						<button id="chat-close-btn" class="btn btn-warning btn-raised" data-dismiss="modal" aria-hidden="true">[[global:close]]</button>
					</span>
				</div>
			</div>
		</div>
