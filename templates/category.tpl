...
<div class="category row">
	<div class="{topic_row_size}" no-widget-class="col-lg-12 col-sm-12" no-widget-target="sidebar">
		...
		<div class="header category-tools clearfix">
			...
			<button id="new_post" class="btn btn-primary btn-raised">[[category:new_topic_button]]</button>
			<!-- ELSE -->
				<!-- IF !loggedIn -->
				<a href="/login?next=category/{slug}" class="btn btn-primary btn-raised">[[category:guest-login-post]]</a>
				<!-- ENDIF !loggedIn -->
					...
					<div class="row">
						<div class="col-md-8 col-sm-9">
							<!-- IF privileges.editable -->
                                ...
                                <label for="{topics.tid}" class="pull-left"></label>
